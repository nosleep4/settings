...
kmi = km.keymap_items.new('view3d.rotate', 'LEFTMOUSE', 'PRESS', alt=True)
kmi = km.keymap_items.new('view3d.move', 'MIDDLEMOUSE', 'PRESS', shift=True, alt=True)
...
kmi.active = False
kmi = km.keymap_items.new('view3d.rotate', 'MOUSEROTATE', 'ANY', alt=True)
kmi.active = False
...
kmi = km.keymap_items.new_modal('SWITCH_TO_MOVE', 'LEFTMOUSE', 'RELEASE')
